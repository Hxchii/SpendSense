...
class ApiRecurringBillRepository implements RecurringBillRepository {
  ApiRecurringBillRepository({required ApiClient client})
      : _c = ApiCollection<RecurringBill>(
          client: client,
  ...
  final ApiCollection<RecurringBill> _c;
