...
class FirestoreAiChatRepository implements AiChatRepository {
  FirestoreAiChatRepository({required FirebaseFirestore firestore, required String uid})
      : _c = FirestoreCollection<AiChatMessage>(
          firestore: firestore,
          uid: uid,
          name: 'ai_chat',
          toJson: _toJson,
  ...
  final FirestoreCollection<AiChatMessage> _c;
