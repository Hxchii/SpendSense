...
class FirestoreCategoryRepository implements CategoryRepository {
  FirestoreCategoryRepository({required FirebaseFirestore firestore, required String uid})
      : _c = FirestoreCollection<Category>(
          firestore: firestore,
          uid: uid,
          name: 'categories',
          toJson: _toJson,
  ...
  final FirestoreCollection<Category> _c;
